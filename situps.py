...
#     disp_feedback_1 = 'KEEP PUSHING BACK'
    disp_feedback_2 = 'Bend your legs'
    disp_feedback_3 = 'Too much leg bend'
#     disp_feedback_4 = 'MOVE KNEES CLOSER TO BODY '
...
#     pTime = 0
    ...
    while cap.isOpened():
        ...
        try:
            ...
            if left_knee_angle > knee_thresh[1] and right_knee_angle > knee_thresh[1]:  
            ...
            elif left_knee_angle < knee_thresh[0] and right_knee_angle < knee_thresh[0]:
                image = draw_2points(image,left_knee,left_ankle,frame_width,frame_height,RED,WHITE)
                image = draw_2points(image,right_knee,right_ankle,frame_width,frame_height,RED,WHITE)
                draw_text(
                        image, 
            ...
            if left_hip_angle > hip_thresh[1] and right_hip_angle > hip_thresh[1]:
                count_flag = 'down'
            if left_hip_angle < hip_thresh[0] and count_flag =='down' and right_hip_angle < hip_thresh[0] :
                if count == reps:
                    count_complete = True
                else:
                    count += 1
...
if __name__=='__main__':
    ...
    engine = pyttsx3.init()   # text to speech initialise
    engine.say('Your situps exercise is about to start, lay down, remember to maintain a good posture and keep in position.')
    engine.runAndWait()
